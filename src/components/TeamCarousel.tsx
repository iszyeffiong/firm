  ...
  return (
    ...
    >
      ...
      {infoPosition === 'bottom' && members[currentIndex] && (
        ...
        >
          <h2
            className="text-4xl font-bold mb-3 relative inline-flex items-center gap-3"
          ...
          >
            ...
            {members[currentIndex].linkedin && (
              <a
                ...
                className="inline-flex items-center justify-center w-8 h-8 bg-[#0077B5] hover:bg-[#005885] text-white rounded-full transition-colors duration-300"
              >
